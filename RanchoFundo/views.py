...
def home(request):
    ...
    return render(request, 'RanchoFundo/home.html', context )

def graficos(request, ano):
    ...
    #grafico pie chart  ['Nublado', 'Chuva', 'Sol']
    lista_tempo = definir_tempo(climas_full)
    lista_tempo[0] = round((lista_tempo[0]/len(climas_full))*100)
    lista_tempo[1] = round((lista_tempo[1]/len(climas_full))*100)
    lista_tempo[2] = round((lista_tempo[2]/len(climas_full))*100)
    ...
    return render(request, 'RanchoFundo/graficos.html', context)
